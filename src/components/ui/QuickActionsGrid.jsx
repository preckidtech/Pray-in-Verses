    ...
    {actions.map((action, index) => {
      ...
      return (
        <Link
          to={action.path}
          key={index}
          className="flex-1 min-w-[120px] max-w-[160px] bg-gray-50 p-4 flex flex-col items-center justify-center shadow hover:shadow-md cursor-pointer transition rounded-lg"
        >
