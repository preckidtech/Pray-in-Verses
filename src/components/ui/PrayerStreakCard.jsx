...
const PrayerStreakCard = ({ streakDays = 5 }) => (
  <div className=" w-full bg-gradient-to-br from-yellow-400 via-yellow-500 to-orange-500 rounded-lg p-4 text-white shadow-lg flex flex-col items-center justify-center max-w-xs mx-auto">
