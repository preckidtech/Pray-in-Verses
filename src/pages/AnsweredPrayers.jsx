...
const AnsweredPrayers = () => {
  ...
  useEffect(() => {
    const savedAnswered = JSON.parse(localStorage.getItem("answeredPrayers") || "[]");
    ...
    <div className="min-h-screen bg-gradient-to-br from-blue-50 via-white to-yellow-50 pt-16 pl-0 lg:pl-[224px] font-['Poppins']">
      ...
      <div className="container mx-auto px-4 py-8">
        ...
        <div className="flex flex-col md:flex-row justify-between items-center mb-6">
          <h1 className="text-base font-semibold text-[#0C2E8A]">Answered Prayers</h1>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
            {filteredPrayers.map((prayer) => (
              ...
              >
                ...
                <h3 className="text-base font-semibold text-[#0C2E8A]">{prayer.title}</h3>
