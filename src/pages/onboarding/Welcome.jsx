...
const Welcome = () => {
  return (
    <div className="h-screen w-screen overflow-hidden bg-gradient-to-br from-primary to-secondary flex items-center justify-center px-6 md:px-16">
      <div className="grid md:grid-cols-2 gap-0 max-w-6xl w-full rounded-2xl shadow-2xl overflow-hidden">
        ...
        <div className="flex flex-col items-center justify-center bg-gradient-to-br from-primary to-secondary text-white py-8 px-6 h-screen md:h-full">
          <img src={logo} alt="logo" className="w-28 mb-4" />
          <h1 className="text-3xl sm:text-4xl font-bold mb-2">Pray in Verses</h1>
